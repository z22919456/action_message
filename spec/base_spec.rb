...
describe ActionShortMessage::Base do
  ...
  context 'class methods' do
    ...
    describe '.method_missing' do
      it 'should instantiate MessageDelivery when .action_methods include the method' do
        ...
        expect(message_delivery).to be_an(ActionShortMessage::MessageDelivery)
  ...
  context 'instance methods' do
    it '#initialize' do
      ...
      expect(subject.instance_variable_get(:@_message)).to be_an(ActionShortMessage::Message)
    end
